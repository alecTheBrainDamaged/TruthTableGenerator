...
/* package truthTable-0.1.0.0 */
#ifndef VERSION_truthTable
#define VERSION_truthTable "0.1.0.0"
#endif /* VERSION_truthTable */
#ifndef MIN_VERSION_truthTable
#define MIN_VERSION_truthTable(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_truthTable */
...
#define CURRENT_COMPONENT_ID "truthTable-0.1.0.0-inplace-truthTable"
